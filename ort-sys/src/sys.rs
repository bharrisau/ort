...
use crate::ctypes::{size_t, sys_char as ORTCHAR_T};
...
pub struct OrtAllocator {
	...
	pub Alloc: ::std::option::Option<crate::ctypes::_system!(unsafe fn(this_: *mut OrtAllocator, size: size_t) -> *mut ::std::os::raw::c_void)>,
	#[doc = "< Free a block of memory previously allocated with OrtAllocator::Alloc"]
	pub Free: ::std::option::Option<crate::ctypes::_system!(unsafe fn(this_: *mut OrtAllocator, p: *mut ::std::os::raw::c_void))>,
...
pub struct OrtApiBase {
	...
	pub GetVersionString: ::std::option::Option<crate::ctypes::_system!(unsafe fn() -> *const ::std::os::raw::c_char)>
}
#[test]
...
pub type OrtThreadWorkerFn = ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_worker_fn_param: *mut ::std::os::raw::c_void))>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct OrtApi {
	...
	pub CreateStatus: ::std::option::Option<crate::ctypes::_system!(unsafe fn(code: OrtErrorCode, msg: *const ::std::os::raw::c_char) -> *mut OrtStatus)>,
	...
	pub GetErrorMessage: ::std::option::Option<crate::ctypes::_system!(unsafe fn(status: *const OrtStatus) -> *const ::std::os::raw::c_char)>,
	pub CreateEnv: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(log_severity_level: OrtLoggingLevel, logid: *const ::std::os::raw::c_char, out: *mut *mut OrtEnv) -> OrtStatusPtr)
	>,
	...
	pub CreateSession: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(env: *const OrtEnv, model_path: *const ORTCHAR_T, options: *const OrtSessionOptions, out: *mut *mut OrtSession) -> OrtStatusPtr
		)
	>,
	...
	pub SetOptimizedModelFilePath:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, optimized_model_filepath: *const ORTCHAR_T) -> OrtStatusPtr)>,
	pub CloneSessionOptions: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(in_options: *const OrtSessionOptions, out_options: *mut *mut OrtSessionOptions) -> OrtStatusPtr)
	>,
	pub SetSessionExecutionMode:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, execution_mode: ExecutionMode) -> OrtStatusPtr)>,
	pub EnableProfiling:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, profile_file_prefix: *const ORTCHAR_T) -> OrtStatusPtr)>,
	...
	pub SetSessionLogId:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, logid: *const ::std::os::raw::c_char) -> OrtStatusPtr)>,
	pub SetSessionLogVerbosityLevel: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, session_log_verbosity_level: ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub SetSessionLogSeverityLevel: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, session_log_severity_level: ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub SetSessionGraphOptimizationLevel: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, graph_optimization_level: GraphOptimizationLevel) -> OrtStatusPtr)
	>,
	pub SetIntraOpNumThreads:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, intra_op_num_threads: ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub SetInterOpNumThreads:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, inter_op_num_threads: ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub CreateCustomOpDomain:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(domain: *const ::std::os::raw::c_char, out: *mut *mut OrtCustomOpDomain) -> OrtStatusPtr)>,
	pub CustomOpDomain_Add:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(custom_op_domain: *mut OrtCustomOpDomain, op: *const OrtCustomOp) -> OrtStatusPtr)>,
	...
	pub SessionGetOverridableInitializerCount:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, out: *mut size_t) -> OrtStatusPtr)>,
	...
	pub SessionGetInputName: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(session: *const OrtSession, index: size_t, allocator: *mut OrtAllocator, value: *mut *mut ::std::os::raw::c_char) -> OrtStatusPtr
		)
	>,
	...
	pub RunOptionsSetRunLogVerbosityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions, log_verbosity_level: ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub RunOptionsSetRunLogSeverityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions, log_severity_level: ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub RunOptionsSetRunTag:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions, run_tag: *const ::std::os::raw::c_char) -> OrtStatusPtr)>,
	pub RunOptionsGetRunLogVerbosityLevel: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *const OrtRunOptions, log_verbosity_level: *mut ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub RunOptionsGetRunLogSeverityLevel: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *const OrtRunOptions, log_severity_level: *mut ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub RunOptionsGetRunTag:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *const OrtRunOptions, run_tag: *mut *const ::std::os::raw::c_char) -> OrtStatusPtr)>,
	...
	>,
	pub IsTensor: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub GetTensorMutableData:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *mut OrtValue, out: *mut *mut ::std::os::raw::c_void) -> OrtStatusPtr)>,
	pub FillStringTensor:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *mut OrtValue, s: *const *const ::std::os::raw::c_char, s_len: size_t) -> OrtStatusPtr)>,
	...
	pub GetStringTensorContent: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(value: *const OrtValue, s: *mut ::std::os::raw::c_void, s_len: size_t, offsets: *mut size_t, offsets_len: size_t) -> OrtStatusPtr
		)
	>,
	...
	pub SetDimensions: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *mut OrtTensorTypeAndShapeInfo, dim_values: *const i64, dim_count: size_t) -> OrtStatusPtr)
	>,
	...
	pub GetDimensions: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtTensorTypeAndShapeInfo, dim_values: *mut i64, dim_values_length: size_t) -> OrtStatusPtr)
	>,
	pub GetSymbolicDimensions: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(info: *const OrtTensorTypeAndShapeInfo, dim_params: *mut *const ::std::os::raw::c_char, dim_params_length: size_t) -> OrtStatusPtr
		)
	>,
	pub GetTensorShapeElementCount:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtTensorTypeAndShapeInfo, out: *mut size_t) -> OrtStatusPtr)>,
	pub GetTensorTypeAndShape:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut *mut OrtTensorTypeAndShapeInfo) -> OrtStatusPtr)>,
	...
	pub CompareMemoryInfo: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info1: *const OrtMemoryInfo, info2: *const OrtMemoryInfo, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub MemoryInfoGetName:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ptr: *const OrtMemoryInfo, out: *mut *const ::std::os::raw::c_char) -> OrtStatusPtr)>,
	pub MemoryInfoGetId: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ptr: *const OrtMemoryInfo, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr)>,
	...
	pub AllocatorAlloc: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(ort_allocator: *mut OrtAllocator, size: size_t, out: *mut *mut ::std::os::raw::c_void) -> OrtStatusPtr)
	>,
	pub AllocatorFree:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_allocator: *mut OrtAllocator, p: *mut ::std::os::raw::c_void) -> OrtStatusPtr)>,
	pub AllocatorGetInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_allocator: *const OrtAllocator, out: *mut *const OrtMemoryInfo) -> OrtStatusPtr)>,
	...
	pub AddFreeDimensionOverride: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, dim_denotation: *const ::std::os::raw::c_char, dim_value: i64) -> OrtStatusPtr)
	>,
	pub GetValue: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(value: *const OrtValue, index: ::std::os::raw::c_int, allocator: *mut OrtAllocator, out: *mut *mut OrtValue) -> OrtStatusPtr
		)
	>,
	...
	pub KernelInfoGetAttribute_float: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, name: *const ::std::os::raw::c_char, out: *mut f32) -> OrtStatusPtr)
	>,
	pub KernelInfoGetAttribute_int64: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, name: *const ::std::os::raw::c_char, out: *mut i64) -> OrtStatusPtr)
	>,
	...
	pub KernelContext_GetInputCount:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, out: *mut size_t) -> OrtStatusPtr)>,
	pub KernelContext_GetOutputCount:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, out: *mut size_t) -> OrtStatusPtr)>,
	...
	pub KernelContext_GetOutput: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(context: *mut OrtKernelContext, index: size_t, dim_values: *const i64, dim_count: size_t, out: *mut *mut OrtValue) -> OrtStatusPtr
		)
	>,
	...
	pub GetDenotationFromTypeInfo: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(type_info: *const OrtTypeInfo, denotation: *mut *const ::std::os::raw::c_char, len: *mut size_t) -> OrtStatusPtr)
	>,
	pub CastTypeInfoToMapTypeInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(type_info: *const OrtTypeInfo, out: *mut *const OrtMapTypeInfo) -> OrtStatusPtr)>,
	...
	pub GetMapKeyType:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(map_type_info: *const OrtMapTypeInfo, out: *mut ONNXTensorElementDataType) -> OrtStatusPtr)>,
	pub GetMapValueType:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(map_type_info: *const OrtMapTypeInfo, type_info: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	pub GetSequenceElementType: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(sequence_type_info: *const OrtSequenceTypeInfo, type_info: *mut *mut OrtTypeInfo) -> OrtStatusPtr)
	>,
	...
	pub SessionEndProfiling: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(session: *mut OrtSession, allocator: *mut OrtAllocator, out: *mut *mut ::std::os::raw::c_char) -> OrtStatusPtr)
	>,
	pub SessionGetModelMetadata:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, out: *mut *mut OrtModelMetadata) -> OrtStatusPtr)>,
	pub ModelMetadataGetProducerName: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(model_metadata: *const OrtModelMetadata, allocator: *mut OrtAllocator, value: *mut *mut ::std::os::raw::c_char) -> OrtStatusPtr
		)
	>,
	...
	pub ModelMetadataGetVersion:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(model_metadata: *const OrtModelMetadata, value: *mut i64) -> OrtStatusPtr)>,
	...
	pub AddFreeDimensionOverrideByName: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, dim_name: *const ::std::os::raw::c_char, dim_value: i64) -> OrtStatusPtr)
	>,
	pub GetAvailableProviders: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(out_ptr: *mut *mut *mut ::std::os::raw::c_char, provider_length: *mut ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub ReleaseAvailableProviders: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(ptr: *mut *mut ::std::os::raw::c_char, providers_length: ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub GetStringTensorElementLength:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, index: size_t, out: *mut size_t) -> OrtStatusPtr)>,
	pub GetStringTensorElement: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(value: *const OrtValue, s_len: size_t, index: size_t, s: *mut ::std::os::raw::c_void) -> OrtStatusPtr)
	>,
	pub FillStringTensorElement:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *mut OrtValue, s: *const ::std::os::raw::c_char, index: size_t) -> OrtStatusPtr)>,
	...
	pub CreateAllocator: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(session: *const OrtSession, mem_info: *const OrtMemoryInfo, out: *mut *mut OrtAllocator) -> OrtStatusPtr)
	>,
	...
	pub BindInput: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(binding_ptr: *mut OrtIoBinding, name: *const ::std::os::raw::c_char, val_ptr: *const OrtValue) -> OrtStatusPtr)
	>,
	...
	pub BindOutputToDevice: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(binding_ptr: *mut OrtIoBinding, name: *const ::std::os::raw::c_char, mem_info_ptr: *const OrtMemoryInfo) -> OrtStatusPtr
		)
	>,
	...
	pub CreateAndRegisterAllocator: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(env: *mut OrtEnv, mem_info: *const OrtMemoryInfo, arena_cfg: *const OrtArenaCfg) -> OrtStatusPtr)
	>,
	pub SetLanguageProjection:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_env: *const OrtEnv, projection: OrtLanguageProjection) -> OrtStatusPtr)>,
	...
	pub SetGlobalIntraOpNumThreads: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, intra_op_num_threads: ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub SetGlobalInterOpNumThreads: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, inter_op_num_threads: ::std::os::raw::c_int) -> OrtStatusPtr)
	>,
	pub SetGlobalSpinControl:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, allow_spinning: ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub AddInitializer: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, name: *const ::std::os::raw::c_char, val: *const OrtValue) -> OrtStatusPtr)
	>,
	...
	pub SessionOptionsAppendExecutionProvider_OpenVINO: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, provider_options: *const OrtOpenVINOProviderOptions) -> OrtStatusPtr)
	>,
	...
	pub SessionOptionsAppendExecutionProvider_TensorRT: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, tensorrt_options: *const OrtTensorRTProviderOptions) -> OrtStatusPtr)
	>,
	pub SetCurrentGpuDeviceId: ::std::option::Option<crate::ctypes::_system!(unsafe fn(device_id: ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub GetCurrentGpuDeviceId: ::std::option::Option<crate::ctypes::_system!(unsafe fn(device_id: *mut ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub KernelInfoGetAttributeArray_float: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, name: *const ::std::os::raw::c_char, out: *mut f32, size: *mut size_t) -> OrtStatusPtr)
	>,
	pub KernelInfoGetAttributeArray_int64: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, name: *const ::std::os::raw::c_char, out: *mut i64, size: *mut size_t) -> OrtStatusPtr)
	>,
	...
	pub SessionOptionsAppendExecutionProvider_TensorRT_V2: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, tensorrt_options: *const OrtTensorRTProviderOptionsV2) -> OrtStatusPtr)
	>,
	...
	pub IsSparseTensor: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr)>,
	...
	>,
	pub UseCooIndices:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_value: *mut OrtValue, indices_data: *mut i64, indices_num: size_t) -> OrtStatusPtr)>,
	pub UseCsrIndices: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(ort_value: *mut OrtValue, inner_data: *mut i64, inner_num: size_t, outer_data: *mut i64, outer_num: size_t) -> OrtStatusPtr
		)
	>,
	pub UseBlockSparseIndices: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(ort_value: *mut OrtValue, indices_shape: *const i64, indices_shape_len: size_t, indices_data: *mut i32) -> OrtStatusPtr
		)
	>,
	...
	pub GetSparseTensorValues:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_value: *const OrtValue, out: *mut *const ::std::os::raw::c_void) -> OrtStatusPtr)>,
	pub GetSparseTensorIndicesTypeShape: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(ort_value: *const OrtValue, indices_format: OrtSparseIndicesFormat, out: *mut *mut OrtTensorTypeAndShapeInfo) -> OrtStatusPtr
		)
	>,
	...
	>,
	pub HasValue: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr)>,
	pub KernelContext_GetGPUComputeStream:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, out: *mut *mut ::std::os::raw::c_void) -> OrtStatusPtr)>,
	pub GetTensorMemoryInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, mem_info: *mut *const OrtMemoryInfo) -> OrtStatusPtr)>,
	pub GetExecutionProviderApi: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(provider_name: *const ::std::os::raw::c_char, version: u32, provider_api: *mut *const ::std::os::raw::c_void) -> OrtStatusPtr
		)
	>,
	pub SessionOptionsSetCustomCreateThreadFn: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, ort_custom_create_thread_fn: OrtCustomCreateThreadFn) -> OrtStatusPtr)
	>,
	pub SessionOptionsSetCustomThreadCreationOptions: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, ort_custom_thread_creation_options: *mut ::std::os::raw::c_void) -> OrtStatusPtr)
	>,
	pub SessionOptionsSetCustomJoinThreadFn: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, ort_custom_join_thread_fn: OrtCustomJoinThreadFn) -> OrtStatusPtr)
	>,
	pub SetGlobalCustomCreateThreadFn: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, ort_custom_create_thread_fn: OrtCustomCreateThreadFn) -> OrtStatusPtr)
	>,
	pub SetGlobalCustomThreadCreationOptions: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(tp_options: *mut OrtThreadingOptions, ort_custom_thread_creation_options: *mut ::std::os::raw::c_void) -> OrtStatusPtr
		)
	>,
	pub SetGlobalCustomJoinThreadFn: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, ort_custom_join_thread_fn: OrtCustomJoinThreadFn) -> OrtStatusPtr)
	>,
	...
	pub SessionOptionsAppendExecutionProvider_CUDA_V2: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, cuda_options: *const OrtCUDAProviderOptionsV2) -> OrtStatusPtr)
	>,
	...
	pub GetCUDAProviderOptionsAsString: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(cuda_options: *const OrtCUDAProviderOptionsV2, allocator: *mut OrtAllocator, ptr: *mut *mut ::std::os::raw::c_char) -> OrtStatusPtr
		)
	>,
	...
	pub SessionOptionsAppendExecutionProvider_MIGraphX: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, migraphx_options: *const OrtMIGraphXProviderOptions) -> OrtStatusPtr)
	>,
	...
	>,
	pub CopyKernelInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, info_copy: *mut *mut OrtKernelInfo) -> OrtStatusPtr)>,
	...
	pub GetCANNProviderOptionsAsString: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(cann_options: *const OrtCANNProviderOptions, allocator: *mut OrtAllocator, ptr: *mut *mut ::std::os::raw::c_char) -> OrtStatusPtr
		)
	>,
	...
	pub UpdateEnvWithCustomLogLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_env: *mut OrtEnv, log_severity_level: OrtLoggingLevel) -> OrtStatusPtr)>,
	pub SetGlobalIntraOpThreadAffinity: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, affinity_string: *const ::std::os::raw::c_char) -> OrtStatusPtr)
	>,
	pub RegisterCustomOpsLibrary_V2:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, library_name: *const ORTCHAR_T) -> OrtStatusPtr)>,
	pub RegisterCustomOpsUsingFunction: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, registration_func_name: *const ::std::os::raw::c_char) -> OrtStatusPtr)
	>,
	...
	pub KernelInfo_GetInputName: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, index: size_t, out: *mut ::std::os::raw::c_char, size: *mut size_t) -> OrtStatusPtr)
	>,
	...
	pub HasSessionConfigEntry: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(options: *const OrtSessionOptions, config_key: *const ::std::os::raw::c_char, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr
		)
	>,
	...
	pub GetDnnlProviderOptionsAsString: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(dnnl_options: *const OrtDnnlProviderOptions, allocator: *mut OrtAllocator, ptr: *mut *mut ::std::os::raw::c_char) -> OrtStatusPtr
		)
	>,
	...
	pub KernelInfo_GetNodeName: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, out: *mut ::std::os::raw::c_char, size: *mut size_t) -> OrtStatusPtr)
	>,
	pub KernelInfo_GetLogger:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, logger: *mut *const OrtLogger) -> OrtStatusPtr)>,
	pub KernelContext_GetLogger:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, logger: *mut *const OrtLogger) -> OrtStatusPtr)>,
	...
	pub Logger_GetLoggingSeverityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(logger: *const OrtLogger, out: *mut OrtLoggingLevel) -> OrtStatusPtr)>,
	pub KernelInfoGetConstantInput_tensor: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(info: *const OrtKernelInfo, index: size_t, is_constant: *mut ::std::os::raw::c_int, out: *mut *const OrtValue) -> OrtStatusPtr
		)
	>,
	...
	pub GetResizedStringTensorElementBuffer: ::std::option::Option<
		crate::ctypes::_system!(
			unsafe fn(value: *mut OrtValue, index: size_t, length_in_bytes: size_t, buffer: *mut *mut ::std::os::raw::c_char) -> OrtStatusPtr
		)
	>,
	...
	pub GetBuildInfoString: ::std::option::Option<crate::ctypes::_system!(unsafe fn() -> *const ::std::os::raw::c_char)>
}
#[test]
...
pub struct OrtCustomOp {
	...
	pub CreateKernel: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp, api: *const OrtApi, info: *const OrtKernelInfo) -> *mut ::std::os::raw::c_void)
	>,
	pub GetName: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> *const ::std::os::raw::c_char)>,
	pub GetExecutionProviderType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> *const ::std::os::raw::c_char)>,
	...
	pub KernelCompute: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op_kernel: *mut ::std::os::raw::c_void, context: *mut OrtKernelContext))>,
	pub KernelDestroy: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op_kernel: *mut ::std::os::raw::c_void))>,
	pub GetInputCharacteristic:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp, index: size_t) -> OrtCustomOpInputOutputCharacteristic)>,
	...
	pub GetVariadicInputMinArity: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> ::std::os::raw::c_int)>,
	pub GetVariadicInputHomogeneity: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> ::std::os::raw::c_int)>,
	pub GetVariadicOutputMinArity: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> ::std::os::raw::c_int)>,
	pub GetVariadicOutputHomogeneity: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> ::std::os::raw::c_int)>
}
#[test]
