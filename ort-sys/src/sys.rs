...
pub type ONNXTensorElementDataType = crate::ctypes::c_uint;
...
pub type ONNXType = crate::ctypes::c_uint;
...
pub type OrtSparseFormat = crate::ctypes::c_uint;
...
pub type OrtSparseIndicesFormat = crate::ctypes::c_uint;
...
pub type OrtLoggingLevel = crate::ctypes::c_uint;
...
pub type OrtErrorCode = crate::ctypes::c_uint;
...
pub type OrtOpAttrType = crate::ctypes::c_uint;
#[repr(C)]
...
pub struct OrtAllocator {
	...
	pub Alloc: ::std::option::Option<crate::ctypes::_system!(unsafe fn(this_: *mut OrtAllocator, size: size_t) -> *mut crate::ctypes::c_void)>,
	#[doc = "< Free a block of memory previously allocated with OrtAllocator::Alloc"]
	pub Free: ::std::option::Option<crate::ctypes::_system!(unsafe fn(this_: *mut OrtAllocator, p: *mut crate::ctypes::c_void))>,
	#[doc = "< Return a pointer to an ::OrtMemoryInfo that describes this allocator"]
	pub Info: ::std::option::Option<crate::ctypes::_system!(unsafe fn(this_: *const OrtAllocator) -> *const OrtMemoryInfo)>,
}
#[test]
...
pub type OrtLoggingFunction = ::std::option::Option<
	crate::ctypes::_system!(unsafe fn(
		param: *mut crate::ctypes::c_void,
		severity: OrtLoggingLevel,
		category: *const crate::ctypes::c_char,
		logid: *const crate::ctypes::c_char,
		code_location: *const crate::ctypes::c_char,
...
pub type OrtLanguageProjection = crate::ctypes::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type OrtAllocatorType = crate::ctypes::c_int;
...
pub type OrtMemType = crate::ctypes::c_int;
...
pub type OrtMemoryInfoDeviceType = crate::ctypes::c_uint;
...
pub struct OrtCUDAProviderOptions {
	...
	pub arena_extend_strategy: crate::ctypes::c_int,
	...
	pub do_copy_in_default_stream: crate::ctypes::c_int,
	#[doc = " \\brief Flag indicating if there is a user provided compute stream\n   Defaults to 0."]
	pub has_user_compute_stream: crate::ctypes::c_int,
	#[doc = " \\brief User provided compute stream.\n   If provided, please set `has_user_compute_stream` to 1."]
	pub user_compute_stream: *mut crate::ctypes::c_void,
	...
	pub tunable_op_enable: crate::ctypes::c_int,
	...
	pub tunable_op_tuning_enable: crate::ctypes::c_int,
}
#[test]
...
pub struct OrtROCMProviderOptions {
	...
	pub miopen_conv_exhaustive_search: crate::ctypes::c_int,
...
pub struct OrtTensorRTProviderOptions {
	...
	pub has_user_compute_stream: crate::ctypes::c_int,
	pub user_compute_stream: *mut crate::ctypes::c_void,
	pub trt_max_partition_iterations: crate::ctypes::c_int,
	pub trt_min_subgraph_size: crate::ctypes::c_int,
	pub trt_max_workspace_size: size_t,
	pub trt_fp16_enable: crate::ctypes::c_int,
	pub trt_int8_enable: crate::ctypes::c_int,
	pub trt_int8_calibration_table_name: *const crate::ctypes::c_char,
	pub trt_int8_use_native_calibration_table: crate::ctypes::c_int,
	pub trt_dla_enable: crate::ctypes::c_int,
	pub trt_dla_core: crate::ctypes::c_int,
	pub trt_dump_subgraphs: crate::ctypes::c_int,
	pub trt_engine_cache_enable: crate::ctypes::c_int,
	pub trt_engine_cache_path: *const crate::ctypes::c_char,
	pub trt_engine_decryption_enable: crate::ctypes::c_int,
	pub trt_engine_decryption_lib_path: *const crate::ctypes::c_char,
	pub trt_force_sequential_engine_build: crate::ctypes::c_int,
}
#[test]
...
pub struct OrtMIGraphXProviderOptions {
	pub device_id: crate::ctypes::c_int,
	pub migraphx_fp16_enable: crate::ctypes::c_int,
	pub migraphx_int8_enable: crate::ctypes::c_int,
}
#[test]
...
pub struct OrtOpenVINOProviderOptions {
	...
	pub device_type: *const crate::ctypes::c_char,
	#[doc = "< 0 = disabled, nonzero = enabled"]
	pub enable_vpu_fast_compile: crate::ctypes::c_uchar,
	pub device_id: *const crate::ctypes::c_char,
	#[doc = "< 0 = Use default number of threads"]
	pub num_of_threads: size_t,
	pub cache_dir: *const crate::ctypes::c_char,
	pub context: *mut crate::ctypes::c_void,
	#[doc = "< 0 = disabled, nonzero = enabled"]
	pub enable_opencl_throttling: crate::ctypes::c_uchar,
	#[doc = "< 0 = disabled, nonzero = enabled"]
	pub enable_dynamic_shapes: crate::ctypes::c_uchar,
}
#[test]
...
pub struct OrtApiBase {
	...
	pub GetApi: ::std::option::Option<crate::ctypes::_system!(unsafe fn(version: u32) -> *const OrtApi)>,
	#[doc = " \\brief Returns a null terminated string of the version of the Onnxruntime library (eg: \"1.8.1\")\n\n  \\return UTF-8 encoded version string. Do not deallocate the returned buffer."]
	pub GetVersionString: ::std::option::Option<crate::ctypes::_system!(unsafe fn() -> *const crate::ctypes::c_char)>,
}
#[test]
...
pub type OrtThreadWorkerFn = ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_worker_fn_param: *mut crate::ctypes::c_void))>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct OrtCustomHandleType {
	pub __place_holder: crate::ctypes::c_char,
}
#[test]
...
pub type OrtCustomCreateThreadFn = ::std::option::Option<
	crate::ctypes::_system!(unsafe fn(
		ort_custom_thread_creation_options: *mut crate::ctypes::c_void,
		ort_thread_worker_fn: OrtThreadWorkerFn,
		ort_worker_fn_param: *mut crate::ctypes::c_void,
	) -> OrtCustomThreadHandle)
>;
#[doc = " \\brief Custom thread join function\n\n Onnxruntime thread pool destructor will call the function to join a custom thread.\n Argument ort_custom_thread_handle is the value returned by OrtCustomCreateThreadFn"]
pub type OrtCustomJoinThreadFn = ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_custom_thread_handle: OrtCustomThreadHandle))>;
#[doc = " \\brief The C API\n\n All C API functions are defined inside this structure as pointers to functions.\n Call OrtApiBase::GetApi to get a pointer to it\n\n \\nosubgrouping"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct OrtApi {
	#[doc = " \\brief Create an OrtStatus from a null terminated string\n\n \\param[in] code\n \\param[in] msg A null-terminated string. Its contents will be copied.\n \\return A new OrtStatus object, must be destroyed with OrtApi::ReleaseStatus"]
	pub CreateStatus: ::std::option::Option<crate::ctypes::_system!(unsafe fn(code: OrtErrorCode, msg: *const crate::ctypes::c_char) -> *mut OrtStatus)>,
	#[doc = " \\brief Get OrtErrorCode from OrtStatus\n\n \\param[in] status\n \\return OrtErrorCode that \\p status was created with"]
	pub GetErrorCode: ::std::option::Option<crate::ctypes::_system!(unsafe fn(status: *const OrtStatus) -> OrtErrorCode)>,
	#[doc = " \\brief Get error string from OrtStatus\n\n \\param[in] status\n \\return The error message inside the `status`. Do not free the returned value."]
	pub GetErrorMessage: ::std::option::Option<crate::ctypes::_system!(unsafe fn(status: *const OrtStatus) -> *const crate::ctypes::c_char)>,
	pub CreateEnv: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(log_severity_level: OrtLoggingLevel, logid: *const crate::ctypes::c_char, out: *mut *mut OrtEnv) -> OrtStatusPtr)
	>,
	pub CreateEnvWithCustomLogger: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			logging_function: OrtLoggingFunction,
			logger_param: *mut crate::ctypes::c_void,
			log_severity_level: OrtLoggingLevel,
			logid: *const crate::ctypes::c_char,
			out: *mut *mut OrtEnv,
		) -> OrtStatusPtr)
	>,
	pub EnableTelemetryEvents: ::std::option::Option<crate::ctypes::_system!(unsafe fn(env: *const OrtEnv) -> OrtStatusPtr)>,
	pub DisableTelemetryEvents: ::std::option::Option<crate::ctypes::_system!(unsafe fn(env: *const OrtEnv) -> OrtStatusPtr)>,
	pub CreateSession: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			env: *const OrtEnv,
			model_path: *const crate::ctypes::c_char,
	...
	pub CreateSessionFromArray: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			env: *const OrtEnv,
			model_data: *const crate::ctypes::c_void,
	...
	pub Run: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			...
			input_names: *const *const crate::ctypes::c_char,
			inputs: *const *const OrtValue,
			input_len: size_t,
			output_names: *const *const crate::ctypes::c_char,
			output_names_len: size_t,
			outputs: *mut *mut OrtValue,
		) -> OrtStatusPtr)
	>,
	pub CreateSessionOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub SetOptimizedModelFilePath:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, optimized_model_filepath: *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub CloneSessionOptions:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(in_options: *const OrtSessionOptions, out_options: *mut *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub SetSessionExecutionMode: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, execution_mode: ExecutionMode) -> OrtStatusPtr)>,
	pub EnableProfiling:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, profile_file_prefix: *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub DisableProfiling: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub EnableMemPattern: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub DisableMemPattern: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub EnableCpuMemArena: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub DisableCpuMemArena: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub SetSessionLogId: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, logid: *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub SetSessionLogVerbosityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, session_log_verbosity_level: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub SetSessionLogSeverityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, session_log_severity_level: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub SetSessionGraphOptimizationLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, graph_optimization_level: GraphOptimizationLevel) -> OrtStatusPtr)>,
	pub SetIntraOpNumThreads:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, intra_op_num_threads: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub SetInterOpNumThreads:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, inter_op_num_threads: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub CreateCustomOpDomain:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(domain: *const crate::ctypes::c_char, out: *mut *mut OrtCustomOpDomain) -> OrtStatusPtr)>,
	pub CustomOpDomain_Add: ::std::option::Option<crate::ctypes::_system!(unsafe fn(custom_op_domain: *mut OrtCustomOpDomain, op: *const OrtCustomOp) -> OrtStatusPtr)>,
	pub AddCustomOpDomain:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, custom_op_domain: *mut OrtCustomOpDomain) -> OrtStatusPtr)>,
	pub RegisterCustomOpsLibrary: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			options: *mut OrtSessionOptions,
			library_path: *const crate::ctypes::c_char,
			library_handle: *mut *mut crate::ctypes::c_void,
		) -> OrtStatusPtr)
	>,
	pub SessionGetInputCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, out: *mut size_t) -> OrtStatusPtr)>,
	pub SessionGetOutputCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, out: *mut size_t) -> OrtStatusPtr)>,
	pub SessionGetOverridableInitializerCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, out: *mut size_t) -> OrtStatusPtr)>,
	pub SessionGetInputTypeInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, index: size_t, type_info: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	pub SessionGetOutputTypeInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, index: size_t, type_info: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	pub SessionGetOverridableInitializerTypeInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, index: size_t, type_info: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	pub SessionGetInputName: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(session: *const OrtSession, index: size_t, allocator: *mut OrtAllocator, value: *mut *mut crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	...
	pub SessionGetOverridableInitializerName: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(session: *const OrtSession, index: size_t, allocator: *mut OrtAllocator, value: *mut *mut crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	pub CreateRunOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtRunOptions) -> OrtStatusPtr)>,
	pub RunOptionsSetRunLogVerbosityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions, log_verbosity_level: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub RunOptionsSetRunLogSeverityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions, log_severity_level: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub RunOptionsSetRunTag: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions, run_tag: *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub RunOptionsGetRunLogVerbosityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *const OrtRunOptions, log_verbosity_level: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub RunOptionsGetRunLogSeverityLevel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *const OrtRunOptions, log_severity_level: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub RunOptionsGetRunTag:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *const OrtRunOptions, run_tag: *mut *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub RunOptionsSetTerminate: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions) -> OrtStatusPtr)>,
	pub RunOptionsUnsetTerminate: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions) -> OrtStatusPtr)>,
	...
	pub CreateTensorWithDataAsOrtValue: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			...
			p_data: *mut crate::ctypes::c_void,
			p_data_len: size_t,
			shape: *const i64,
			shape_len: size_t,
			type_: ONNXTensorElementDataType,
	...
	>,
	pub IsTensor: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub GetTensorMutableData: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *mut OrtValue, out: *mut *mut crate::ctypes::c_void) -> OrtStatusPtr)>,
	pub FillStringTensor:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *mut OrtValue, s: *const *const crate::ctypes::c_char, s_len: size_t) -> OrtStatusPtr)>,
	pub GetStringTensorDataLength: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, len: *mut size_t) -> OrtStatusPtr)>,
	pub GetStringTensorContent: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(value: *const OrtValue, s: *mut crate::ctypes::c_void, s_len: size_t, offsets: *mut size_t, offsets_len: size_t) -> OrtStatusPtr)
	>,
	pub CastTypeInfoToTensorInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(type_info: *const OrtTypeInfo, out: *mut *const OrtTensorTypeAndShapeInfo) -> OrtStatusPtr)>,
	pub GetOnnxTypeFromTypeInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(type_info: *const OrtTypeInfo, out: *mut ONNXType) -> OrtStatusPtr)>,
	pub CreateTensorTypeAndShapeInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtTensorTypeAndShapeInfo) -> OrtStatusPtr)>,
	pub SetTensorElementType:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *mut OrtTensorTypeAndShapeInfo, type_: ONNXTensorElementDataType) -> OrtStatusPtr)>,
	pub SetDimensions:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *mut OrtTensorTypeAndShapeInfo, dim_values: *const i64, dim_count: size_t) -> OrtStatusPtr)>,
	pub GetTensorElementType:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtTensorTypeAndShapeInfo, out: *mut ONNXTensorElementDataType) -> OrtStatusPtr)>,
	pub GetDimensionsCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtTensorTypeAndShapeInfo, out: *mut size_t) -> OrtStatusPtr)>,
	pub GetDimensions:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtTensorTypeAndShapeInfo, dim_values: *mut i64, dim_values_length: size_t) -> OrtStatusPtr)>,
	pub GetSymbolicDimensions: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtTensorTypeAndShapeInfo, dim_params: *mut *const crate::ctypes::c_char, dim_params_length: size_t) -> OrtStatusPtr)
	>,
	pub GetTensorShapeElementCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtTensorTypeAndShapeInfo, out: *mut size_t) -> OrtStatusPtr)>,
	pub GetTensorTypeAndShape: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut *mut OrtTensorTypeAndShapeInfo) -> OrtStatusPtr)>,
	pub GetTypeInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	pub GetValueType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut ONNXType) -> OrtStatusPtr)>,
	...
	pub CreateCpuMemoryInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(type_: OrtAllocatorType, mem_type: OrtMemType, out: *mut *mut OrtMemoryInfo) -> OrtStatusPtr)>,
	pub CompareMemoryInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info1: *const OrtMemoryInfo, info2: *const OrtMemoryInfo, out: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub MemoryInfoGetName: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ptr: *const OrtMemoryInfo, out: *mut *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub MemoryInfoGetId: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ptr: *const OrtMemoryInfo, out: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub MemoryInfoGetMemType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ptr: *const OrtMemoryInfo, out: *mut OrtMemType) -> OrtStatusPtr)>,
	pub MemoryInfoGetType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ptr: *const OrtMemoryInfo, out: *mut OrtAllocatorType) -> OrtStatusPtr)>,
	pub AllocatorAlloc:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_allocator: *mut OrtAllocator, size: size_t, out: *mut *mut crate::ctypes::c_void) -> OrtStatusPtr)>,
	pub AllocatorFree: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_allocator: *mut OrtAllocator, p: *mut crate::ctypes::c_void) -> OrtStatusPtr)>,
	pub AllocatorGetInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_allocator: *const OrtAllocator, out: *mut *const OrtMemoryInfo) -> OrtStatusPtr)>,
	pub GetAllocatorWithDefaultOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtAllocator) -> OrtStatusPtr)>,
	pub AddFreeDimensionOverride: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, dim_denotation: *const crate::ctypes::c_char, dim_value: i64) -> OrtStatusPtr)
	>,
	pub GetValue: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(value: *const OrtValue, index: crate::ctypes::c_int, allocator: *mut OrtAllocator, out: *mut *mut OrtValue) -> OrtStatusPtr)
	>,
	pub GetValueCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut size_t) -> OrtStatusPtr)>,
	pub CreateValue: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(in_: *const *const OrtValue, num_values: size_t, value_type: ONNXType, out: *mut *mut OrtValue) -> OrtStatusPtr)
	>,
	pub CreateOpaqueValue: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			domain_name: *const crate::ctypes::c_char,
			type_name: *const crate::ctypes::c_char,
			data_container: *const crate::ctypes::c_void,
	...
	pub GetOpaqueValue: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			...
			type_name: *const crate::ctypes::c_char,
			in_: *const OrtValue,
			data_container: *mut crate::ctypes::c_void,
			data_container_size: size_t,
		) -> OrtStatusPtr)
	>,
	pub KernelInfoGetAttribute_float:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, name: *const crate::ctypes::c_char, out: *mut f32) -> OrtStatusPtr)>,
	pub KernelInfoGetAttribute_int64:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, name: *const crate::ctypes::c_char, out: *mut i64) -> OrtStatusPtr)>,
	...
	>,
	pub KernelContext_GetInputCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, out: *mut size_t) -> OrtStatusPtr)>,
	pub KernelContext_GetOutputCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, out: *mut size_t) -> OrtStatusPtr)>,
	pub KernelContext_GetInput:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, index: size_t, out: *mut *const OrtValue) -> OrtStatusPtr)>,
	pub KernelContext_GetOutput: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(context: *mut OrtKernelContext, index: size_t, dim_values: *const i64, dim_count: size_t, out: *mut *mut OrtValue) -> OrtStatusPtr)
	>,
	pub ReleaseEnv: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtEnv))>,
	pub ReleaseStatus: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtStatus))>,
	...
	pub ReleaseTensorTypeAndShapeInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtTensorTypeAndShapeInfo))>,
	pub ReleaseSessionOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtSessionOptions))>,
	pub ReleaseCustomOpDomain: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtCustomOpDomain))>,
	pub GetDenotationFromTypeInfo: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(type_info: *const OrtTypeInfo, denotation: *mut *const crate::ctypes::c_char, len: *mut size_t) -> OrtStatusPtr)
	>,
	pub CastTypeInfoToMapTypeInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(type_info: *const OrtTypeInfo, out: *mut *const OrtMapTypeInfo) -> OrtStatusPtr)>,
	pub CastTypeInfoToSequenceTypeInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(type_info: *const OrtTypeInfo, out: *mut *const OrtSequenceTypeInfo) -> OrtStatusPtr)>,
	pub GetMapKeyType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(map_type_info: *const OrtMapTypeInfo, out: *mut ONNXTensorElementDataType) -> OrtStatusPtr)>,
	pub GetMapValueType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(map_type_info: *const OrtMapTypeInfo, type_info: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	pub GetSequenceElementType:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(sequence_type_info: *const OrtSequenceTypeInfo, type_info: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	pub ReleaseMapTypeInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtMapTypeInfo))>,
	pub ReleaseSequenceTypeInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtSequenceTypeInfo))>,
	pub SessionEndProfiling: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(session: *mut OrtSession, allocator: *mut OrtAllocator, out: *mut *mut crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	pub SessionGetModelMetadata: ::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, out: *mut *mut OrtModelMetadata) -> OrtStatusPtr)>,
	pub ModelMetadataGetProducerName: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(model_metadata: *const OrtModelMetadata, allocator: *mut OrtAllocator, value: *mut *mut crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	...
	pub ModelMetadataLookupCustomMetadataMap: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			...
			allocator: *mut OrtAllocator,
			key: *const crate::ctypes::c_char,
			value: *mut *mut crate::ctypes::c_char,
		) -> OrtStatusPtr)
	>,
	pub ModelMetadataGetVersion: ::std::option::Option<crate::ctypes::_system!(unsafe fn(model_metadata: *const OrtModelMetadata, value: *mut i64) -> OrtStatusPtr)>,
	pub ReleaseModelMetadata: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtModelMetadata))>,
	...
	>,
	pub DisablePerSessionThreads: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub CreateThreadingOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtThreadingOptions) -> OrtStatusPtr)>,
	pub ReleaseThreadingOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtThreadingOptions))>,
	pub ModelMetadataGetCustomMetadataMapKeys: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			model_metadata: *const OrtModelMetadata,
			allocator: *mut OrtAllocator,
			keys: *mut *mut *mut crate::ctypes::c_char,
			num_keys: *mut i64,
		) -> OrtStatusPtr)
	>,
	pub AddFreeDimensionOverrideByName:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, dim_name: *const crate::ctypes::c_char, dim_value: i64) -> OrtStatusPtr)>,
	pub GetAvailableProviders:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(out_ptr: *mut *mut *mut crate::ctypes::c_char, provider_length: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub ReleaseAvailableProviders:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ptr: *mut *mut crate::ctypes::c_char, providers_length: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub GetStringTensorElementLength: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, index: size_t, out: *mut size_t) -> OrtStatusPtr)>,
	pub GetStringTensorElement:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, s_len: size_t, index: size_t, s: *mut crate::ctypes::c_void) -> OrtStatusPtr)>,
	pub FillStringTensorElement:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *mut OrtValue, s: *const crate::ctypes::c_char, index: size_t) -> OrtStatusPtr)>,
	pub AddSessionConfigEntry: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			options: *mut OrtSessionOptions,
			config_key: *const crate::ctypes::c_char,
			config_value: *const crate::ctypes::c_char,
		) -> OrtStatusPtr)
	>,
	pub CreateAllocator:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, mem_info: *const OrtMemoryInfo, out: *mut *mut OrtAllocator) -> OrtStatusPtr)>,
	...
	pub RunWithBinding: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(session: *mut OrtSession, run_options: *const OrtRunOptions, binding_ptr: *const OrtIoBinding) -> OrtStatusPtr)
	>,
	pub CreateIoBinding: ::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *mut OrtSession, out: *mut *mut OrtIoBinding) -> OrtStatusPtr)>,
	pub ReleaseIoBinding: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtIoBinding))>,
	pub BindInput: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(binding_ptr: *mut OrtIoBinding, name: *const crate::ctypes::c_char, val_ptr: *const OrtValue) -> OrtStatusPtr)
	>,
	pub BindOutput: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(binding_ptr: *mut OrtIoBinding, name: *const crate::ctypes::c_char, val_ptr: *const OrtValue) -> OrtStatusPtr)
	>,
	pub BindOutputToDevice: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(binding_ptr: *mut OrtIoBinding, name: *const crate::ctypes::c_char, mem_info_ptr: *const OrtMemoryInfo) -> OrtStatusPtr)
	>,
	pub GetBoundOutputNames: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			binding_ptr: *const OrtIoBinding,
			allocator: *mut OrtAllocator,
			buffer: *mut *mut crate::ctypes::c_char,
	...
	pub TensorAt: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			...
			out: *mut *mut crate::ctypes::c_void,
		) -> OrtStatusPtr)
	>,
	pub CreateAndRegisterAllocator:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(env: *mut OrtEnv, mem_info: *const OrtMemoryInfo, arena_cfg: *const OrtArenaCfg) -> OrtStatusPtr)>,
	pub SetLanguageProjection: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_env: *const OrtEnv, projection: OrtLanguageProjection) -> OrtStatusPtr)>,
	pub SessionGetProfilingStartTimeNs: ::std::option::Option<crate::ctypes::_system!(unsafe fn(session: *const OrtSession, out: *mut u64) -> OrtStatusPtr)>,
	pub SetGlobalIntraOpNumThreads:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, intra_op_num_threads: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub SetGlobalInterOpNumThreads:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, inter_op_num_threads: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub SetGlobalSpinControl:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, allow_spinning: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub AddInitializer:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, name: *const crate::ctypes::c_char, val: *const OrtValue) -> OrtStatusPtr)>,
	...
	pub SessionOptionsAppendExecutionProvider_CUDA:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, cuda_options: *const OrtCUDAProviderOptions) -> OrtStatusPtr)>,
	pub SessionOptionsAppendExecutionProvider_ROCM:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, rocm_options: *const OrtROCMProviderOptions) -> OrtStatusPtr)>,
	pub SessionOptionsAppendExecutionProvider_OpenVINO:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, provider_options: *const OrtOpenVINOProviderOptions) -> OrtStatusPtr)>,
	pub SetGlobalDenormalAsZero: ::std::option::Option<crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions) -> OrtStatusPtr)>,
	pub CreateArenaCfg: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			max_mem: size_t,
			arena_extend_strategy: crate::ctypes::c_int,
			initial_chunk_size_bytes: crate::ctypes::c_int,
			max_dead_bytes_per_chunk: crate::ctypes::c_int,
	...
	pub SessionOptionsAppendExecutionProvider_TensorRT:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, tensorrt_options: *const OrtTensorRTProviderOptions) -> OrtStatusPtr)>,
	pub SetCurrentGpuDeviceId: ::std::option::Option<crate::ctypes::_system!(unsafe fn(device_id: crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub GetCurrentGpuDeviceId: ::std::option::Option<crate::ctypes::_system!(unsafe fn(device_id: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub KernelInfoGetAttributeArray_float: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, name: *const crate::ctypes::c_char, out: *mut f32, size: *mut size_t) -> OrtStatusPtr)
	>,
	pub KernelInfoGetAttributeArray_int64: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, name: *const crate::ctypes::c_char, out: *mut i64, size: *mut size_t) -> OrtStatusPtr)
	>,
	pub CreateArenaCfgV2: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			arena_config_keys: *const *const crate::ctypes::c_char,
	...
	pub AddRunConfigEntry: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtRunOptions, config_key: *const crate::ctypes::c_char, config_value: *const crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	pub CreatePrepackedWeightsContainer: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtPrepackedWeightsContainer) -> OrtStatusPtr)>,
	pub ReleasePrepackedWeightsContainer: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtPrepackedWeightsContainer))>,
	...
	pub SessionOptionsAppendExecutionProvider_TensorRT_V2:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, tensorrt_options: *const OrtTensorRTProviderOptionsV2) -> OrtStatusPtr)>,
	pub CreateTensorRTProviderOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtTensorRTProviderOptionsV2) -> OrtStatusPtr)>,
	pub UpdateTensorRTProviderOptions: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			tensorrt_options: *mut OrtTensorRTProviderOptionsV2,
			provider_options_keys: *const *const crate::ctypes::c_char,
			provider_options_values: *const *const crate::ctypes::c_char,
			num_keys: size_t,
		) -> OrtStatusPtr)
	>,
	pub GetTensorRTProviderOptionsAsString: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			...
			allocator: *mut OrtAllocator,
			ptr: *mut *mut crate::ctypes::c_char,
		) -> OrtStatusPtr)
	>,
	#[doc = " \\brief Release an ::OrtTensorRTProviderOptionsV2\n\n \\note This is an exception in the naming convention of other Release* functions, as the name of the method does not have the V2 suffix, but the type does"]
	pub ReleaseTensorRTProviderOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtTensorRTProviderOptionsV2))>,
	pub EnableOrtCustomOps: ::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions) -> OrtStatusPtr)>,
	pub RegisterAllocator: ::std::option::Option<crate::ctypes::_system!(unsafe fn(env: *mut OrtEnv, allocator: *mut OrtAllocator) -> OrtStatusPtr)>,
	pub UnregisterAllocator: ::std::option::Option<crate::ctypes::_system!(unsafe fn(env: *mut OrtEnv, mem_info: *const OrtMemoryInfo) -> OrtStatusPtr)>,
	pub IsSparseTensor: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	...
	pub FillSparseTensorCoo: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			...
			values: *const crate::ctypes::c_void,
	...
	>,
	pub UseCooIndices: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_value: *mut OrtValue, indices_data: *mut i64, indices_num: size_t) -> OrtStatusPtr)>,
	pub UseCsrIndices: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(ort_value: *mut OrtValue, inner_data: *mut i64, inner_num: size_t, outer_data: *mut i64, outer_num: size_t) -> OrtStatusPtr)
	>,
	pub UseBlockSparseIndices: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(ort_value: *mut OrtValue, indices_shape: *const i64, indices_shape_len: size_t, indices_data: *mut i32) -> OrtStatusPtr)
	>,
	pub GetSparseTensorFormat: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_value: *const OrtValue, out: *mut OrtSparseFormat) -> OrtStatusPtr)>,
	pub GetSparseTensorValuesTypeAndShape:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_value: *const OrtValue, out: *mut *mut OrtTensorTypeAndShapeInfo) -> OrtStatusPtr)>,
	pub GetSparseTensorValues: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_value: *const OrtValue, out: *mut *const crate::ctypes::c_void) -> OrtStatusPtr)>,
	pub GetSparseTensorIndicesTypeShape: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(ort_value: *const OrtValue, indices_format: OrtSparseIndicesFormat, out: *mut *mut OrtTensorTypeAndShapeInfo) -> OrtStatusPtr)
	>,
	pub GetSparseTensorIndices: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			...
			indices: *mut *const crate::ctypes::c_void,
		) -> OrtStatusPtr)
	>,
	pub HasValue: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, out: *mut crate::ctypes::c_int) -> OrtStatusPtr)>,
	pub KernelContext_GetGPUComputeStream:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, out: *mut *mut crate::ctypes::c_void) -> OrtStatusPtr)>,
	pub GetTensorMemoryInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(value: *const OrtValue, mem_info: *mut *const OrtMemoryInfo) -> OrtStatusPtr)>,
	pub GetExecutionProviderApi: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(provider_name: *const crate::ctypes::c_char, version: u32, provider_api: *mut *const crate::ctypes::c_void) -> OrtStatusPtr)
	>,
	pub SessionOptionsSetCustomCreateThreadFn:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, ort_custom_create_thread_fn: OrtCustomCreateThreadFn) -> OrtStatusPtr)>,
	pub SessionOptionsSetCustomThreadCreationOptions: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, ort_custom_thread_creation_options: *mut crate::ctypes::c_void) -> OrtStatusPtr)
	>,
	pub SessionOptionsSetCustomJoinThreadFn:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, ort_custom_join_thread_fn: OrtCustomJoinThreadFn) -> OrtStatusPtr)>,
	pub SetGlobalCustomCreateThreadFn:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, ort_custom_create_thread_fn: OrtCustomCreateThreadFn) -> OrtStatusPtr)>,
	pub SetGlobalCustomThreadCreationOptions: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, ort_custom_thread_creation_options: *mut crate::ctypes::c_void) -> OrtStatusPtr)
	>,
	pub SetGlobalCustomJoinThreadFn:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, ort_custom_join_thread_fn: OrtCustomJoinThreadFn) -> OrtStatusPtr)>,
	pub SynchronizeBoundInputs: ::std::option::Option<crate::ctypes::_system!(unsafe fn(binding_ptr: *mut OrtIoBinding) -> OrtStatusPtr)>,
	pub SynchronizeBoundOutputs: ::std::option::Option<crate::ctypes::_system!(unsafe fn(binding_ptr: *mut OrtIoBinding) -> OrtStatusPtr)>,
	pub SessionOptionsAppendExecutionProvider_CUDA_V2:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, cuda_options: *const OrtCUDAProviderOptionsV2) -> OrtStatusPtr)>,
	pub CreateCUDAProviderOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtCUDAProviderOptionsV2) -> OrtStatusPtr)>,
	...
	pub GetCUDAProviderOptionsAsString: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(cuda_options: *const OrtCUDAProviderOptionsV2, allocator: *mut OrtAllocator, ptr: *mut *mut crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	#[doc = " \\brief Release an ::OrtCUDAProviderOptionsV2\n\n \\note This is an exception in the naming convention of other Release* functions, as the name of the method does not have the V2 suffix, but the type does\n\n \\since Version 1.11."]
	pub ReleaseCUDAProviderOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtCUDAProviderOptionsV2))>,
	pub SessionOptionsAppendExecutionProvider_MIGraphX:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, migraphx_options: *const OrtMIGraphXProviderOptions) -> OrtStatusPtr)>,
	pub AddExternalInitializers: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			options: *mut OrtSessionOptions,
			initializer_names: *const *const crate::ctypes::c_char,
	...
	pub CreateOp: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			info: *const OrtKernelInfo,
			op_name: *const crate::ctypes::c_char,
			domain: *const crate::ctypes::c_char,
			version: crate::ctypes::c_int,
			type_constraint_names: *mut *const crate::ctypes::c_char,
			type_constraint_values: *const ONNXTensorElementDataType,
			type_constraint_count: crate::ctypes::c_int,
			attr_values: *const *const OrtOpAttr,
			attr_count: crate::ctypes::c_int,
			input_count: crate::ctypes::c_int,
			output_count: crate::ctypes::c_int,
	...
	pub SessionOptionsAppendExecutionProvider: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			options: *mut OrtSessionOptions,
			provider_name: *const crate::ctypes::c_char,
			provider_options_keys: *const *const crate::ctypes::c_char,
			provider_options_values: *const *const crate::ctypes::c_char,
			num_keys: size_t,
		) -> OrtStatusPtr)
	>,
	pub CopyKernelInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, info_copy: *mut *mut OrtKernelInfo) -> OrtStatusPtr)>,
	pub ReleaseKernelInfo: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtKernelInfo))>,
	...
	pub GetTrainingApi: ::std::option::Option<crate::ctypes::_system!(unsafe fn(version: u32) -> *const OrtTrainingApi)>,
	pub SessionOptionsAppendExecutionProvider_CANN:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, cann_options: *const OrtCANNProviderOptions) -> OrtStatusPtr)>,
	pub CreateCANNProviderOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtCANNProviderOptions) -> OrtStatusPtr)>,
	...
	pub GetCANNProviderOptionsAsString: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(cann_options: *const OrtCANNProviderOptions, allocator: *mut OrtAllocator, ptr: *mut *mut crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	#[doc = " \\brief Release an OrtCANNProviderOptions\n\n \\param[in] the pointer of OrtCANNProviderOptions which will been deleted\n\n \\since Version 1.13."]
	pub ReleaseCANNProviderOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtCANNProviderOptions))>,
	pub MemoryInfoGetDeviceType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ptr: *const OrtMemoryInfo, out: *mut OrtMemoryInfoDeviceType))>,
	pub UpdateEnvWithCustomLogLevel: ::std::option::Option<crate::ctypes::_system!(unsafe fn(ort_env: *mut OrtEnv, log_severity_level: OrtLoggingLevel) -> OrtStatusPtr)>,
	pub SetGlobalIntraOpThreadAffinity:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(tp_options: *mut OrtThreadingOptions, affinity_string: *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub RegisterCustomOpsLibrary_V2:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, library_name: *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub RegisterCustomOpsUsingFunction:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, registration_func_name: *const crate::ctypes::c_char) -> OrtStatusPtr)>,
	pub KernelInfo_GetInputCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, out: *mut size_t) -> OrtStatusPtr)>,
	pub KernelInfo_GetOutputCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, out: *mut size_t) -> OrtStatusPtr)>,
	pub KernelInfo_GetInputName: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, index: size_t, out: *mut crate::ctypes::c_char, size: *mut size_t) -> OrtStatusPtr)
	>,
	pub KernelInfo_GetOutputName: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, index: size_t, out: *mut crate::ctypes::c_char, size: *mut size_t) -> OrtStatusPtr)
	>,
	pub KernelInfo_GetInputTypeInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, index: size_t, type_info: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	...
	pub HasSessionConfigEntry: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(options: *const OrtSessionOptions, config_key: *const crate::ctypes::c_char, out: *mut crate::ctypes::c_int) -> OrtStatusPtr)
	>,
	pub GetSessionConfigEntry: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			options: *const OrtSessionOptions,
			config_key: *const crate::ctypes::c_char,
			config_value: *mut crate::ctypes::c_char,
			size: *mut size_t,
		) -> OrtStatusPtr)
	>,
	pub SessionOptionsAppendExecutionProvider_Dnnl:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(options: *mut OrtSessionOptions, dnnl_options: *const OrtDnnlProviderOptions) -> OrtStatusPtr)>,
	pub CreateDnnlProviderOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(out: *mut *mut OrtDnnlProviderOptions) -> OrtStatusPtr)>,
	...
	pub GetDnnlProviderOptionsAsString: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(dnnl_options: *const OrtDnnlProviderOptions, allocator: *mut OrtAllocator, ptr: *mut *mut crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	#[doc = " \\brief Release an ::OrtDnnlProviderOptions\n\n \\since Version 1.15."]
	pub ReleaseDnnlProviderOptions: ::std::option::Option<crate::ctypes::_system!(unsafe fn(input: *mut OrtDnnlProviderOptions))>,
	pub KernelInfo_GetNodeName:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, out: *mut crate::ctypes::c_char, size: *mut size_t) -> OrtStatusPtr)>,
	pub KernelInfo_GetLogger: ::std::option::Option<crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, logger: *mut *const OrtLogger) -> OrtStatusPtr)>,
	pub KernelContext_GetLogger: ::std::option::Option<crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, logger: *mut *const OrtLogger) -> OrtStatusPtr)>,
	pub Logger_LogMessage: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(
			logger: *const OrtLogger,
			log_severity_level: OrtLoggingLevel,
			message: *const crate::ctypes::c_char,
			file_path: *const crate::ctypes::c_char,
			line_number: crate::ctypes::c_int,
			func_name: *const crate::ctypes::c_char,
		) -> OrtStatusPtr)
	>,
	pub Logger_GetLoggingSeverityLevel: ::std::option::Option<crate::ctypes::_system!(unsafe fn(logger: *const OrtLogger, out: *mut OrtLoggingLevel) -> OrtStatusPtr)>,
	pub KernelInfoGetConstantInput_tensor: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(info: *const OrtKernelInfo, index: size_t, is_constant: *mut crate::ctypes::c_int, out: *mut *const OrtValue) -> OrtStatusPtr)
	>,
	pub CastTypeInfoToOptionalTypeInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(type_info: *const OrtTypeInfo, out: *mut *const OrtOptionalTypeInfo) -> OrtStatusPtr)>,
	pub GetOptionalContainedTypeInfo:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(optional_type_info: *const OrtOptionalTypeInfo, out: *mut *mut OrtTypeInfo) -> OrtStatusPtr)>,
	pub GetResizedStringTensorElementBuffer: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(value: *mut OrtValue, index: size_t, length_in_bytes: size_t, buffer: *mut *mut crate::ctypes::c_char) -> OrtStatusPtr)
	>,
	pub KernelContext_GetAllocator: ::std::option::Option<
		crate::ctypes::_system!(unsafe fn(context: *const OrtKernelContext, mem_info: *const OrtMemoryInfo, out: *mut *mut OrtAllocator) -> OrtStatusPtr)
	>,
	#[doc = " \\brief Returns a null terminated string of the build info including git info and cxx flags\n\n \\return UTF-8 encoded version string. Do not deallocate the returned buffer.\n\n \\since Version 1.15."]
	pub GetBuildInfoString: ::std::option::Option<crate::ctypes::_system!(unsafe fn() -> *const crate::ctypes::c_char)>,
}
#[test]
fn bindgen_test_layout_OrtApi() {
	const UNINIT: ::std::mem::MaybeUninit<OrtApi> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(::std::mem::size_of::<OrtApi>(), 2040usize, concat!("Size of: ", stringify!(OrtApi)));
...
pub type OrtCustomOpInputOutputCharacteristic = crate::ctypes::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct OrtCustomOp {
	pub version: u32,
	pub CreateKernel:
		::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp, api: *const OrtApi, info: *const OrtKernelInfo) -> *mut crate::ctypes::c_void)>,
	pub GetName: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> *const crate::ctypes::c_char)>,
	pub GetExecutionProviderType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> *const crate::ctypes::c_char)>,
	pub GetInputType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp, index: size_t) -> ONNXTensorElementDataType)>,
	pub GetInputTypeCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> size_t)>,
	pub GetOutputType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp, index: size_t) -> ONNXTensorElementDataType)>,
	pub GetOutputTypeCount: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> size_t)>,
	pub KernelCompute: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op_kernel: *mut crate::ctypes::c_void, context: *mut OrtKernelContext))>,
	pub KernelDestroy: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op_kernel: *mut crate::ctypes::c_void))>,
	pub GetInputCharacteristic: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp, index: size_t) -> OrtCustomOpInputOutputCharacteristic)>,
	pub GetOutputCharacteristic: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp, index: size_t) -> OrtCustomOpInputOutputCharacteristic)>,
	pub GetInputMemoryType: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp, index: size_t) -> OrtMemType)>,
	pub GetVariadicInputMinArity: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> crate::ctypes::c_int)>,
	pub GetVariadicInputHomogeneity: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> crate::ctypes::c_int)>,
	pub GetVariadicOutputMinArity: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> crate::ctypes::c_int)>,
	pub GetVariadicOutputHomogeneity: ::std::option::Option<crate::ctypes::_system!(unsafe fn(op: *const OrtCustomOp) -> crate::ctypes::c_int)>,
}
#[test]
...
crate::ctypes::_system_block!{
	pub fn OrtSessionOptionsAppendExecutionProvider_CUDA(options: *mut OrtSessionOptions, device_id: crate::ctypes::c_int) -> OrtStatusPtr;
}
crate::ctypes::_system_block!{
	pub fn OrtSessionOptionsAppendExecutionProvider_MIGraphX(options: *mut OrtSessionOptions, device_id: crate::ctypes::c_int) -> OrtStatusPtr;
}
crate::ctypes::_system_block!{
	pub fn OrtSessionOptionsAppendExecutionProvider_Dnnl(options: *mut OrtSessionOptions, use_arena: crate::ctypes::c_int) -> OrtStatusPtr;
}
